...
import type { DesktopBridge, DesktopState, DevelopmentPluginRequest, NavigationAction, TitleMenuAction, WindowAction } from './shared/contracts.js'
...
const bridge: DesktopBridge = {
  ...
  navigate: (action: NavigationAction) => ipcRenderer.invoke('desktop:navigate', action) as Promise<void>,
